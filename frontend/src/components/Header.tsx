...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 w-full bg-white dark:bg-slate-900 z-[60] border-b border-gray-100 dark:border-slate-800 transition-colors duration-300">
