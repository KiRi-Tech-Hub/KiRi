        ...
        <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-white pt-20 transition-colors duration-300">
            ...
            <AuroraBackground>
                <div className="relative px-4 flex flex-col justify-center items-center overflow-hidden z-10 w-full max-w-7xl mx-auto">
                    ...
                    <div className="text-center space-y-8 animate-fade-in relative">
                        ...
                        <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-serif font-bold tracking-tight text-slate-900 dark:text-white leading-[1.05]">
                        ...
                        <p className="text-base md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed font-light px-4 sm:px-0">
                        ...
                        {/* Buttons - Refined */}
                        <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 pt-8 px-4 sm:px-0">
                            <button onClick={() => setIsModalOpen(true)} className="group relative px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-full font-semibold text-sm uppercase tracking-widest transition-all hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 overflow-hidden w-full sm:w-auto">
                            ...
                            <Link to="/portfolio" className="w-full sm:w-auto">
                                <button className="px-8 py-4 bg-transparent hover:bg-slate-50 dark:hover:bg-slate-900 text-slate-600 dark:text-slate-400 rounded-full font-semibold text-sm uppercase tracking-widest transition-all border border-slate-200 dark:border-slate-800 hover:border-slate-400 dark:hover:border-slate-600 w-full">
                                    Our Work
                                </button>
                            </Link>
                        </div>
            ...
            <section className="py-20 border-t border-slate-100 dark:border-slate-900 bg-slate-50 dark:bg-slate-900/50">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <p className="text-blue-600 dark:text-blue-500 font-bold tracking-widest uppercase text-[10px] sm:text-xs mb-4">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 max-w-3xl mx-auto text-base sm:text-lg mb-12">
                        Acting as your technology partner from idea validation to scalable product launch.
                    </p>

                    <BentoGrid className="max-w-4xl mx-auto auto-rows-auto md:auto-rows-[20rem] grid-cols-1 md:grid-cols-3">
                        {[
                            {
                                title: "Collaborative Approach",
                                description: "We work as an extension of your team, ensuring total alignment.",
                                header: <div className="flex flex-1 w-full h-full min-h-[10rem] md:min-h-[6rem] rounded-xl overflow-hidden"><img src="/collaborative.png" alt="Collaborative Approach" className="w-full h-full object-cover opacity-80 group-hover/bento:scale-105 transition-transform duration-300" /></div>,
                            ...
                            },
                            {
                                ...
                                header: <div className="flex flex-1 w-full h-full min-h-[10rem] md:min-h-[6rem] rounded-xl overflow-hidden"><img src="/ideatoproduct.png" alt="Idea-to-Product Guidance" className="w-full h-full object-cover opacity-80 group-hover/bento:scale-105 transition-transform duration-300" /></div>,
                            ...
                            },
                            {
                                ...
                                header: <div className="flex flex-1 w-full h-full min-h-[10rem] md:min-h-[6rem] rounded-xl overflow-hidden"><img src="/agileexecution.png" alt="Agile Execution" className="w-full h-full object-cover opacity-80 group-hover/bento:scale-105 transition-transform duration-300" /></div>,
                            ...
                            },
                            {
                                ...
                                header: (
                                    <div className="flex flex-col space-y-4 justify-center items-center h-full w-full overflow-hidden bg-neutral-100 dark:bg-neutral-900 rounded-xl relative min-h-[12rem] md:min-h-full">
                                        {/* Gradient Masks */}
                            ...
                            },
                            {
                                ...
                                header: <div className="flex flex-1 w-full h-full min-h-[10rem] md:min-h-[6rem] rounded-xl overflow-hidden"><img src="/growth.png" alt="Growth Focused" className="w-full h-full object-cover opacity-80 group-hover/bento:scale-105 transition-transform duration-300" /></div>,
            ...
            < section className="py-20 px-4" >
                <div className="max-w-5xl mx-auto bg-neutral-950 rounded-3xl p-8 md:p-20 text-center relative overflow-hidden border border-neutral-800">
                    <BackgroundBeams className="opacity-40" />

                    <div className="relative z-10 space-y-8">
                        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-white tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                            Elevate Your Digital <br className="hidden sm:block" /> Presence Today
                        </h2>
                        ...
                        <button onClick={() => setIsModalOpen(true)} className="px-8 py-4 bg-white text-neutral-950 rounded-full font-bold text-sm uppercase tracking-widest transition-all hover:scale-105 shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] inline-flex items-center justify-center gap-2 z-50 w-full sm:w-auto">
